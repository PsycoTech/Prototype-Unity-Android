...
public class sensor_trigger : MonoBehaviour
{
    ...
    {
        if (_targets.Contains(other.transform) || (other.gameObject.layer != game_variables.Instance.LayerPlayer && other.gameObject.layer != game_variables.Instance.LayerMob) || other.isTrigger)
            return;
        // exclude dead new
        if (other.gameObject.layer == game_variables.Instance.LayerPlayer || other.gameObject.layer == game_variables.Instance.LayerMob)
        {
            ...
            if (other.gameObject.layer == game_variables.Instance.LayerPlayer && other.GetComponent<data_player>().ModeInvisible)
                return;
            if (other.GetComponent<entity_data>().HealthInst > 0)
